...
import fr.educentre.demo.dto.VehiculeSubCategoryRequestDto;
...
public class VehiculeController {
    ...
    public ResponseEntity<VehiculeSubCategory> createSubCategory(@PathVariable int id, @Valid @RequestBody VehiculeSubCategoryRequestDto dto) throws URISyntaxException, VehiculeCategoryNotFoundException {
        VehiculeCategory category = vehiculeService.findCategoryById(id);
        if (category == null) {
            throw new VehiculeCategoryNotFoundException();
        }
        VehiculeSubCategory subCategory = vehiculeService.createSubCategory(category, dto.getName());
